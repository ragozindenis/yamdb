# Generated by Django 3.2 on 2023-01-25 23:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Недопустимый username', regex='^[\\w.@+-]+$')], verbose_name='Псевдоним')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveIntegerField(validators=[reviews.models.validate_year], verbose_name='Год создания произведения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(validators=[django.core.validators.MaxValueValidator(10, 'Оценка не должна превышать 10'), django.core.validators.MinValueValidator(1, 'Оценка не должна быть меньше 1')])),
